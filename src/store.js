...
const useStore = create((set) => ({
    ...
    quests:[
        ...
        // ==========================================
        {
            ...
            levels: [
                { id: "2-1",
                    title: "Шестеренки Станции", gridSize: 6, maxTurns: 14, lockTurn: 10, scanRadius: 4, botBehavior: "standard", hazards: ["auto_rotate"],
                ...
                { id: "2-2", title: "Нестабильный Поток", gridSize: 6, maxTurns: 15, lockTurn: 9, scanRadius: 4, botBehavior: "smart_pathfinder",
                    ...
                    objectives: { main: { text: "Собрать 6 Энерго-Ядра в динамическом поле", type: "COLLECT_AMOUNT", target: 6 } },
                    rewards: { completionCredits: 650, creditPerTreasure: 25, turnSpeedBonus: 35 } },
                { id: "2-3",
                    title: "Перепитать Генераторы",
                    gridSize: 7,
                    maxTurns: 16,
                    lockTurn: 8,
                    scanRadius: 5,
                    botBehavior: "smart_pathfinder",
                    hazards: ["auto_rotate", "locked_tile"],
                    fixedTreasures: { 'generator': 4,type: "generator" },
                    objectives: { main: { text: "Подключить 2 терминала", type: "CONNECT_TERMINALS", target: 2 } },
                    rewards: { completionCredits: 800, creditPerTreasure: 30, turnSpeedBonus: 40 } }
            ]
        },
        ...
        // ==========================================
        {
            ...
            levels: [
                { id: "3-1",
                    title: "Односторонний Переход",
                    gridSize: 6,
                    maxTurns: 14,
                    lockTurn: 10,
                    scanRadius: 4,
                    botBehavior: "standard",
                    hazards: ["one_way_tile"],
                    fixedTreasures: { 'generator': 0, type:"next" },
                    objectives: { main: { text: "Пройти через односторонние клапаны", type: "COLLECT_AMOUNT", target: 6 } },
                    rewards: { completionCredits: 600, creditPerTreasure: 25, turnSpeedBonus: 30 } },
                { id: "3-2",
                    title: "Лабиринт Клапанов",
                    gridSize: 6, maxTurns: 16, lockTurn: 11, scanRadius: 4, botBehavior: "smart_pathfinder",
                    hazards: ["one_way_tile", "locked_tile"],
                    fixedTreasures: {'generator': 0, 'leg-data': 8, type:"leg-data" },
                    objectives: { main: { text: "Собрать 8 логов, не попав в тупик", type: "COLLECT_AMOUNT", target: 8 } },
                    rewards: { completionCredits: 750, creditPerTreasure: 30, turnSpeedBonus: 35 } },
                { id: "3-3",
                    title: "Маршрут Навигатора",
                    gridSize: 7,
                    maxTurns: 18,
                    lockTurn: 12,
                    scanRadius: 4,
                    botBehavior: "smart_pathfinder",
                    hazards: ["one_way_tile", "auto_rotate"],
                    fixedTreasures: {'generator': 0, type:"sector"},
                    objectives: { main: { text: "Найти путь к 4 сектору", type: "COLLECT_AMOUNT", target: 1 } },
                    rewards: { completionCredits: 900, creditPerTreasure: 35, turnSpeedBonus: 40 } }
            ]
        },
        ...
        // ==========================================
        {
            ...
            levels: [
                { id: "4-1",
                    title: "Квантовые Мосты",
                    gridSize: 8,
                    maxTurns: 16,
                    lockTurn: 12,
                    scanRadius: 5,
                    botBehavior: "smart_pathfinder",
                    hazards: ["portal_nodes"],
                    fixedTreasures: {'generator': 0, 'nav_chip':10, type:'nav_chip'},
                    objectives: { main: { text: "Использовать порталы для сбора чипов", type: "COLLECT_AMOUNT", target: 8 } },
                    rewards: { completionCredits: 850, creditPerTreasure: 30, turnSpeedBonus: 35 } },
                { id: "4-2",
                    title: "Перекрестный Сканер",
                    gridSize: 7,
                    maxTurns: 17,
                    lockTurn: 11,
                    scanRadius: 5,
                    botBehavior: "cheater_omnipresent",
                    hazards: ["portal_nodes", "one_way_tile"],
                    fixedTreasures: { 'generator': 0, type:"portal" },
                    objectives: { main: { text: "Пройти через 4 портала", type: "COLLECT_AMOUNT", target: 4 } },
                    rewards: { completionCredits: 1000, creditPerTreasure: 35, turnSpeedBonus: 40 } },
                { id: "4-3",
                    title: "Зачистка Купола",
                    gridSize: 7,
                    maxTurns: 18,
                    lockTurn: 10,
                    scanRadius: 5,
                    botBehavior: "cheater_omnipresent",
                    hazards: ["portal_nodes", "auto_rotate"],
                    fixedTreasures: { 'leg-data': 12 },
                    objectives: { main: { text: "Собрать 12 логов на всех островах", type: "COLLECT_AMOUNT", target: 12 } },
                    rewards: { completionCredits: 1200, creditPerTreasure: 40, turnSpeedBonus: 45 } }
            ]
        },
